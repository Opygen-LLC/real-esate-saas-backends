...
const submit = catchAsync(async (req: Request, res: Response) => sendResponse(res, { statusCode: httpStatus.CREATED, success: true, message: 'Thank you. Your review was submitted for approval.', data: withWebsiteSubmissionReceipt('review', await ReviewService.submit(req.body)) }))
