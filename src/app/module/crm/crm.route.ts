...
router.get('/assignees', authMiddlewares.requireAnyPermission('properties.read', 'leads.read', 'contacts.read', 'tasks.read', 'viewings.read', 'crm.configure'), CrmController.getAssignees)
