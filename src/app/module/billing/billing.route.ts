...
router.post('/quote', authMiddlewares.requirePermission('billing.manage'), validateRequest(z.object({ body: agencySubscriptionChangeRequestSchema })), BillingController.getSubscriptionQuote)
