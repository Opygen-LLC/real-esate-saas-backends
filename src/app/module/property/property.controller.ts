...
const propertyExportFilters = (req: Request) => pick(req.query, [
  ...
  'pricingMode', 'minUnitRate', 'maxUnitRate', 'minRoadWidthFeet', 'facing', 'approvalAuthority', 'minRooms',
  'starRating', 'hotelOperatingStatus', 'minLandArea', 'maxLandArea', 'landAreaUnit', 'minSecurityDeposit', 'availableBy',
  'furnished', 'isFeatured', 'agentId',
])
