...
router.post('/', authMiddlewares.auth('agency_owner', 'agency_admin', 'agent'),
...
router.get('/', authMiddlewares.auth('agency_owner', 'agency_admin', 'agent'), SupportController.getMyTickets)
router.post('/:id/reply', authMiddlewares.auth('agency_owner', 'agency_admin', 'agent', 'super-admin'),
...
router.post('/:id/attachments/presign', authMiddlewares.auth('agency_owner', 'agency_admin', 'agent', 'super-admin'),
...
router.get('/:id/attachments/:attachmentId/download', authMiddlewares.auth('agency_owner', 'agency_admin', 'agent', 'super-admin'), SupportController.getAttachmentDownload)
router.post('/:id/attachments/:attachmentId/complete', authMiddlewares.auth('agency_owner', 'agency_admin', 'agent', 'super-admin'), SupportController.completeAttachmentUpload)
