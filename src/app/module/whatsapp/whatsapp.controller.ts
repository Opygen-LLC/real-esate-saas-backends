...
const sendTemplate = catchAsync(async (req: Request, res: Response) => sendResponse(res, { statusCode: 202, success: true, message: 'WhatsApp message accepted', data: await WhatsAppService.sendTemplate(requireTenant(req), { ...req.body, actorId: req.user?._id }) }))
