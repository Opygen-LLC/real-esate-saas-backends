...
const financeDividendSchema = new Schema<IFinanceDividend>({
  ...
  amountMinor: safeMinor, paidMinor: safeMinor, currency: { type: String, required: true, enum: ['BDT'], default: 'BDT', uppercase: true, trim: true },
...
const financeLoanSchema = new Schema<IFinanceLoan>({
  ...
  currency: { type: String, required: true, enum: ['BDT'], default: 'BDT', uppercase: true, trim: true }, bankAccountId: { type: Schema.Types.ObjectId, ref: 'FinanceBankAccount', required: true },
