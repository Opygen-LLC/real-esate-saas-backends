...
export const FinanceAccountingValidation = {
  ...
  listAccounts: z.object({ query: z.object({ type: accountType.optional(), status: z.enum(['ACTIVE', 'INACTIVE']).optional(), search: z.string().trim().max(160).optional() }).strict() }),
  ...
  listFiscalPeriods: z.object({ query: z.object({ fiscalYearId: objectId.optional() }).strict() }),
