...
const transactionSchema = new Schema<IFinanceTransaction>(
  {
    ...
    bankAccountId: { type: Schema.Types.ObjectId, ref: 'FinanceBankAccount', index: true },
...
const invoiceSchema = new Schema<IFinanceInvoice>(
  {
    ...
    taxCodeId: { type: Schema.Types.ObjectId, ref: 'FinanceTaxCode', default: null, index: true },
