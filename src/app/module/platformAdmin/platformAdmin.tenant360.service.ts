  ...
  return {
    ...
    subscriptionAndEntitlements: {
      ...
      effectiveLimits: {
        ...
        hasCustomerFinance: Boolean(effectiveSnapshot.limits.hasCustomerFinance),
        hasMaterialsInventory: Boolean(effectiveSnapshot.limits.hasMaterialsInventory),
        hasSupplierManagement: Boolean(effectiveSnapshot.limits.hasSupplierManagement),
