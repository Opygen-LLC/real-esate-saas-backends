...
router.post('/resend_otp', otpRateLimiter, validateRequest(AuthValidation.phoneZodSchema), AuthController.resendOtp)
router.post('/password-reset/request', otpRateLimiter, validateRequest(AuthValidation.phoneZodSchema), AuthController.requestPasswordReset)
