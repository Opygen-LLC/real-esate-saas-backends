...
taskSchema.index({ organizationId: 1, dueAt: 1, _id: 1 }, { name: 'task_tenant_dueat_cursor' })
taskSchema.index({ organizationId: 1, createdAt: -1, _id: -1 }, { name: 'task_tenant_created_cursor' })
...
taskSchema.index({ organizationId: 1, linkedProperty: 1, dueAt: 1 }, { name: 'task_tenant_property_dueat' })
