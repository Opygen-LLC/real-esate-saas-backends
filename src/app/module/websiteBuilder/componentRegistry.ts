...
const FOOTER_ANIMATIONS = ['none', 'fade-in', 'fade-up', 'reveal-up'] as const satisfies readonly AnimationPreset[]

const registry = [
  { id: 'header.modern-glass.v1', name: 'Modern Glass', slot: 'shared.header', category: 'header', version: 1, status: 'ACTIVE', tier: 'PREMIUM', entitlement: 'premiumTemplates', description: 'Independent floating glass navigation with responsive agency actions.', thumbnail: null, supportedAnimations: HEADER_ANIMATIONS },
  { id: 'header.luxury-centered.v1', name: 'Luxury Centered', slot: 'shared.header', category: 'header', version: 1, status: 'ACTIVE', tier: 'PREMIUM', entitlement: 'premiumTemplates', description: 'Centered editorial navigation designed for premium real-estate brands.', thumbnail: null, supportedAnimations: HEADER_ANIMATIONS },
  { id: 'header.corporate-split.v1', name: 'Corporate Split', slot: 'shared.header', category: 'header', version: 1, status: 'ACTIVE', tier: 'FREE', entitlement: 'included', description: 'Structured brokerage header with contact-first navigation.', thumbnail: null, supportedAnimations: HEADER_ANIMATIONS },
  { id: 'footer.mega.v1', name: 'Mega Footer', slot: 'shared.footer', category: 'footer', version: 1, status: 'ACTIVE', tier: 'FREE', entitlement: 'included', description: 'Large multi-column agency footer with navigation, contact details and social links.', thumbnail: null, supportedAnimations: FOOTER_ANIMATIONS },
  { id: 'footer.minimal.v1', name: 'Minimal Footer', slot: 'shared.footer', category: 'footer', version: 1, status: 'ACTIVE', tier: 'FREE', entitlement: 'included', description: 'Compact navigation-first footer for clean contemporary websites.', thumbnail: null, supportedAnimations: FOOTER_ANIMATIONS },
  { id: 'footer.luxury-centered.v1', name: 'Luxury Centered Footer', slot: 'shared.footer', category: 'footer', version: 1, status: 'ACTIVE', tier: 'PREMIUM', entitlement: 'premiumTemplates', description: 'Centered editorial footer for premium residential brands.', thumbnail: null, supportedAnimations: FOOTER_ANIMATIONS },
