...
router.get('/pages', authMiddlewares.auth(), WebsiteBuilderController.getAllPages)
router.get('/pages/:id', authMiddlewares.auth(), WebsiteBuilderController.getPageById)
