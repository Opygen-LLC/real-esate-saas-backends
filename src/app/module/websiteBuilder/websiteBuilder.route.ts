...
import { uploadPresignRateLimiter, uploadRateLimiter, websiteMutationRateLimiter } from '../../middlewares/rateLimiter'
...
router.post('/studio/publish', authMiddlewares.requirePermission('website.write'), websiteMutationRateLimiter, validateRequest(WebsiteStudioValidation.publish), WebsiteStudioController.publish)
router.post('/studio/restore', authMiddlewares.requirePermission('website.write'), websiteMutationRateLimiter, validateRequest(WebsiteStudioValidation.restore), WebsiteStudioController.restore)
router.post('/studio/reset', authMiddlewares.requirePermission('website.write'), websiteMutationRateLimiter, validateRequest(WebsiteStudioValidation.reset), WebsiteStudioController.reset)
...
router.post('/pages/:id/publish', authMiddlewares.requirePermission('website.write'), websiteMutationRateLimiter, validateRequest(WebsiteBuilderValidation.pageParamsSchema), WebsiteBuilderController.publishPage)
router.post('/pages/:id/schedule', authMiddlewares.requirePermission('website.write'), websiteMutationRateLimiter, validateRequest(WebsiteBuilderValidation.pageParamsSchema), validateRequest(WebsiteBuilderValidation.scheduleSchema), WebsiteBuilderController.schedulePublish)
...
router.post('/pages/:id/revisions/:version/restore', authMiddlewares.requirePermission('website.write'), websiteMutationRateLimiter, validateRequest(WebsiteBuilderValidation.revisionParamsSchema), WebsiteBuilderController.restoreRevision)
...
router.post('/assets/presign', authMiddlewares.requirePermission('website.write'), uploadPresignRateLimiter, validateRequest(WebsiteBuilderValidation.presignAssetSchema), WebsiteBuilderController.presignAsset)
router.post('/assets/import-url', authMiddlewares.requirePermission('website.write'), uploadRateLimiter, validateRequest(WebsiteBuilderValidation.importAssetUrlSchema), WebsiteBuilderController.importAssetUrl)
router.post('/assets/complete', authMiddlewares.requirePermission('website.write'), uploadRateLimiter, validateRequest(WebsiteBuilderValidation.completeAssetSchema), WebsiteBuilderController.completeAsset)
