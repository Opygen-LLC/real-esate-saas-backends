...
const sanitizeImage = async (
  ...
  try {
    ...
    const resized = await sharp(buffer, { failOn: 'error', limitInputPixels: 40_000_000 })
      .rotate()
    ...
    throw new ApiError(httpStatus.BAD_REQUEST, 'The uploaded file is not a valid image', '', 'INVALID_UPLOAD_IMAGE')
  }
}
