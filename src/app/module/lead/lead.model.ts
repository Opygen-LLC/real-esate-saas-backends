...
const leadSchema = new Schema<ILead, LeadModel>({
  ...
  propertyInterest:[{type:Schema.Types.ObjectId,ref:'Property'}],locationPreference:{type:String,default:''},propertyType:{type:String,default:'Apartment'},bedrooms:{type:Number,default:1},leadStatus:{type:String,enum:LEAD_STATUS_VALUES,default:LEAD_STATUS.NEW,required:true,index:true},
