...
const createLead=async(organizationId:string,payload:Partial<ILead>,creatorAgentId?:string):Promise<ILead>=>{
  ...
  const prepared:any={...payload,phone:normalizedPhone,normalizedPhone,email:normalizedEmail||undefined,normalizedEmail,source:payload.source||'Website',leadStatus:payload.leadStatus?requireLeadStatus(payload.leadStatus):LEAD_STATUS.NEW}
