...
const deleteLead=catchAsync(async(req,res)=>sendResponse(res,{statusCode:200,success:true,message:'Lead deleted successfully',data:await LeadService.deleteLead(requireTenant(req),req.params.id)}))
