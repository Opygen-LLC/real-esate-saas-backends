// Authoritative shared source. Run scripts/sync-website-catalog-contracts.mjs after changes.
...
/**
 * Canonical property-spec contract. The frontend copy is generated; do not duplicate policies.
...
export type ViewingRequestablePropertyStatus = (typeof VIEWING_REQUESTABLE_PROPERTY_STATUSES)[number]
