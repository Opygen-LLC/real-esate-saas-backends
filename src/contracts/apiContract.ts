export const API_ERROR_CODES = {
  ...
  INVALID_UPLOAD_FIELD: 'INVALID_UPLOAD_FIELD',
  INVALID_UPLOAD_FOLDER: 'INVALID_UPLOAD_FOLDER',
  INVALID_UPLOAD_ID: 'INVALID_UPLOAD_ID',
  INVALID_UPLOAD_SIZE: 'INVALID_UPLOAD_SIZE',
  INVALID_UPLOAD_COMPLETION: 'INVALID_UPLOAD_COMPLETION',
  UPLOAD_INTENT_NOT_FOUND: 'UPLOAD_INTENT_NOT_FOUND',
  UPLOAD_INTENT_NOT_PENDING: 'UPLOAD_INTENT_NOT_PENDING',
  UPLOAD_INTENT_EXPIRED: 'UPLOAD_INTENT_EXPIRED',
  UPLOAD_INTENT_MISMATCH: 'UPLOAD_INTENT_MISMATCH',
  UPLOAD_INTENT_REJECTED: 'UPLOAD_INTENT_REJECTED',
  UPLOAD_KEY_FORBIDDEN: 'UPLOAD_KEY_FORBIDDEN',
  UPLOAD_COMPLETION_IN_PROGRESS: 'UPLOAD_COMPLETION_IN_PROGRESS',
  UPLOAD_COMPLETION_UNAVAILABLE: 'UPLOAD_COMPLETION_UNAVAILABLE',
  ...
  PUBLIC_WEBSITE_UNAVAILABLE: 'PUBLIC_WEBSITE_UNAVAILABLE',
  PUBLIC_WEBSITE_NOT_PUBLISHED: 'PUBLIC_WEBSITE_NOT_PUBLISHED',
